 ...
 public class BoyerMoore {
	...
	public Iterable<Integer> findAll(String txt) {
        ...
        for (int i = 0; i <= N - M; i += skip) {
            ...
            if (skip == 0) {
				hits.enqueue(i);   // found
				skip = 1;         // precisamos verificar outras ocorrencias
			}   
        }
		if (hits.isEmpty()) hits.enqueue(N);  // not found
		return hits;
	}
    ...
    public static void main(String[] args) {
		...
		Iterable<Integer> iter = boyermoore1.findAll(txt);
