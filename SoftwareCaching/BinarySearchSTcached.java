 ...
 *  <i>Algorithms, 4th Edition</i> by Robert Sedgewick and Kevin Wayne.
 */
public class BinarySearchSTcached<Key extends Comparable<Key>, Value> {
     ...
     */
    public BinarySearchSTcached(int capacity) { 
    ...
    public Value get(Key key) {
        ...
        int i;
        if (cache < N && keys[cache] != null && key.compareTo(keys[cache]) == 0)    // verifica a validade do cache
            i = cache;
        else
            i = rank(key);
        cache = i;
    ...
    public void delete(Key key) {
        ...
        int i;
        if (keys[cache] != null && key.compareTo(keys[cache]) == 0)   // verifica o cache
           i = cache;
        else
            i = rank(key);
       cache = i;
