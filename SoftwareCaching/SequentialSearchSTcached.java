/******************************************************************************
 *  Compilation:  javac SequentialSearchSTcached.java
 ...
 *  @author Kevin Wayne
 */
public class SequentialSearchSTcached<Key, Value> {
    private int N;           // number of key-value pairs
    private Node first;      // the linked list of key-value pairs
    private Node cache;      // last acceced key
     ...
     */
    public SequentialSearchSTcached() {
    }
    ...
    public Value get(Key key) {
        ...
        if (cache != null && key.equals(cache.key))                                          // verifica a validade do cache
            return cache.val;
    ...
    public static void main(String[] args) {
        SequentialSearchSTcached<String, Integer> st = new SequentialSearchSTcached<String, Integer>();
